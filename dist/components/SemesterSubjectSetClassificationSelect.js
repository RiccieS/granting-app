 ...
 */
export const SemesterSubjectSetClassificationSelect = ({
  index,
  filteredData,
  levels
}) => {
  ...
  return /*#__PURE__*/React.createElement("select", {
    ...
    onChange: e => {
      handleLevelChange(e.target.value, filteredData);
    }
  }, /*#__PURE__*/React.createElement("option", {
    value: ""
  }, "Select Level"), levels.map(level => /*#__PURE__*/React.createElement("option", {
    key: level.id,
    value: level.id
  }, level.name)));
};

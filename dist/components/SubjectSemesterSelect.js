...
export function SubjectSemesterSelect() {
  ...
  const {
    subjectNames,
    selectedSubject
  } = useSelector(state => state.subjectSemesterSelect);
  useEffect(() => {
    /**
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    htmlFor: "subjectSemester-select"
  }, "Semestr p\u0159edm\u011Btu:"), /*#__PURE__*/React.createElement("div", {
    className: "card-body"
  }, /*#__PURE__*/React.createElement("select", {
    className: "form-select",
    id: "subjectSemester-select",
    value: selectedSubject,
    onChange: handleChange
  }, /*#__PURE__*/React.createElement("option", {
    value: ""
  }, "- Vyberte -"), subjectNames.map(subject => /*#__PURE__*/React.createElement("option", {
    key: [subject.subjectID, subject.semesterID],
    value: [subject.subjectID, subject.semesterID]
  }, subject.subjectName, "-", subject.semesterOrder))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("canvas", {
    id: "subjectSemester-chart"
  }))));
}
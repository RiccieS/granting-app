...
export function StudentsBySubjectSemesterSelect() {
  ...
  const handleChange = async event => {
    ...
    const filteredAcsemesterPage = acsemesterPage.filter(entry => entry.classifications.length > 0);
    const filteredData = filteredAcsemesterPage.filter(entry => {
      return entry.classifications[0].semester.id === semesterID && entry.classifications[0].semester.subject.id === subjectID;
    });
  ...
  }, "Studenti podle semestru p\u0159edm\u011Btu:"), /*#__PURE__*/React.createElement("div", {
    className: "card-body"
  }, /*#__PURE__*/React.createElement("select", {
    className: "form-select",
    id: "subject-select",
    value: selectedSubjectForTable,
    onChange: handleChange
  }, /*#__PURE__*/React.createElement("option", {
    value: ""
  }, "- Vyberte -"), subjectNamesForTable.map(subject => /*#__PURE__*/React.createElement("option", {
    key: subject.subjectID,
    value: [subject.subjectID, subject.semesterID]
  }, subject.subjectName, "-", subject.semesterOrder)))), /*#__PURE__*/React.createElement(StudentsBySubjectSemesterTable, null));
}
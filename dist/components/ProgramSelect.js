...
export function ProgramSelect() {
  ...
  const {
    programNames,
    selectedProgram
  } = useSelector(state => state.programSelect);
  useEffect(() => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Studijn\xED program:"), /*#__PURE__*/React.createElement("div", {
    className: "card-body"
    ...
    value: ""
  }, "- Vyberte -"), programNames.map(program => /*#__PURE__*/React.createElement("option", {
    key: program.id,
    value: program.id
  }, program.name, " - ", program.type.title.name))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("canvas", {
    id: "program-chart"
  }))));
}
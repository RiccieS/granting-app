  ...
  try {
    ...
    for (const studentId of studentIds) {
      ...
      if (selectedSemester >= 1 && selectedSemester <= 10 && data.data.result.classifications.length > 0) {
        ...
        const filteredClassifications = classifications.classifications.filter(classification => classification.semester && classification.semester.order && classification.semester.order.toString() === selectedSemester.toString());
